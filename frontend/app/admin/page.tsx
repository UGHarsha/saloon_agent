...
import { LogOut, LayoutDashboard, Users, Calendar, Settings, Menu, X, Image as ImageIcon } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const navItems = [
    ...
    { name: "Lookbook", href: "/admin/lookbook", icon: Settings },
  ];
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-[#C69C6D]/10 rounded-lg flex items-center justify-center">
                    <ImageIcon className="w-6 h-6 text-[#C69C6D]" />
                  </div>
                  <div>
                    <h3 className="font-bold text-stone-800 mb-1">Manage Lookbook</h3>
                    <p className="text-xs text-stone-400">Add or delete gallery images</p>
                  </div>
                </div>
              </Link>
